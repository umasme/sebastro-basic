...
def create_point_cloud(camera, depth_frame=None, color_frame=None, visualize=False):
    """
    ...
    Args:
        ...
        color_frame: Color frame. If None, will capture a new frame.
    ...
    if depth_frame is None or color_frame is None:
        depth_frame, color_frame = get_frames(camera)
